...
function separateHigherAvgValues(){
    ...
    const new_collection = "statistika1_superconductivity_unique_m";  
    const new_collection2 = "statistika2_superconductivity_unique_m";  
    ...
    const tempCollectionAccess = db.statistika1_superconductivity_unique_m;
    const tempCollectionAccess2 = db.statistika2_superconductivity_unique_m;
